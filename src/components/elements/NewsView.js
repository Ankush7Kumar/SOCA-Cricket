...
import NewsViewMobile from '../elements/NewsViewMobile'
...
const NewsView = (props) => {
  ...
  if (!isMobile) {
    ...
    retval = <div className="tiles-item-news to-flex center-content-mobile-newsview reveal-from-left" data-reveal-delay="200"  >
      <div >
        <Image
      ...
      <div className="text-alignment tiles-item-inner-news mediacolor" >
