  ...
  return (
    ...
    >
      <div className="container">
        ...
        <FeaturesSplit position={aboutOfficials[12].position} name={aboutOfficials[12].name} infoo={aboutOfficials[12].infoo} imag={aboutOfficials[12].imagelink} invertMobile  imageFill className="illustration-section-02 "  />
